...
class SpotifyReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val isAd = isAdMetadata(id, artist, track)
        ...
        val localIntent = Intent().apply {
            ...
            action = if (isAd) {
                ...
                ACTION_AD_DETECTED
            } else if (id.isEmpty() && artist.isEmpty() && track.isEmpty()) {
     ...
     */
    internal fun isAdMetadata(id: String, artist: String, track: String): Boolean {
        return id.startsWith("spotify:ad") ||
                artist.isBlank() ||
